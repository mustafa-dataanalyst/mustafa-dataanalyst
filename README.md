...
I work across the analytics workflow from data cleaning and SQL analysis to Python-based exploration, KPI development, data modeling, and interactive Power BI dashboards , Any problem with Data i gotcha 
